...
WT <- "WT0" #enter weather type here
area_type <- "Grub" #enter your WT type here (Grub, Canopy or [Grub, Canopy] for both) #
data_type = "vaisala" #pick "vaisala" or "hobo"
destination_folder = "Validation_ENVImet"
site_selections = list(1,2,3,4,5,6,7,8,9) #enter what sites you want (for vaisala and hobo) (JUST THE NUMBER!!!)
